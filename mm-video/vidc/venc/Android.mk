...
ifeq ($(TARGET_QCOM_DISPLAY_VARIANT),caf-7x30)
DISPLAY := display-caf-7x30
else
DISPLAY := display
endif
...
libmm-venc-inc      += hardware/qcom/media-caf-7x30/mm-core/inc
libmm-venc-inc      += hardware/qcom/media-caf-7x30/libstagefrighthw
libmm-venc-inc      += hardware/qcom/$(DISPLAY)/libgralloc
libmm-venc-inc      += hardware/libhardware/include/hardware/
libmm-venc-inc      += frameworks/native/include/media/hardware
libmm-venc-inc      += frameworks/native/include/media/openmax
libmm-venc-inc      += hardware/qcom/media-caf-7x30/libc2dcolorconvert
...
mm-venc-test720p-inc            += hardware/qcom/media-caf-7x30/mm-core/inc
...
LOCAL_C_INCLUDES                += hardware/qcom/media-caf-7x30/mm-core/inc
LOCAL_ADDITIONAL_DEPENDENCIES   := $(TARGET_OUT_INTERMEDIATES)/KERNEL_OBJ/usr
LOCAL_PRELINK_MODULE            := false
